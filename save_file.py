                ...
                if loop_1 != loop_2:
                    try:
                        ...
                        if loop_2 != user_choice:
                            ...
                            r2 = v1 * v2 * v3
                            if r2 > 1.00001:
                                saveFile.write(print(user_choice, loop_1, '->', v1 ,loop_1, loop_2, '->', v2 ,loop_2, user_choice,'->', v3 ,
                                      "-----------------------------------------  =  %0.7f" % r2))
                                ...
                                if loop_num_2 != loop_3:
                                    try:
                                        ...
                                        if loop_3 != user_choice:
                                            ...
                                            r4 = v1 * v2 * v4 * v5
                                            if r4 > 1.0001:
                                                saveFile.write(print(user_choice, loop_1, '->', v1, loop_1, loop_2, '->', v2,
                                                      loop_2, loop_3, '->', v4,
                                                    ...
                                                    if loop_num_3 != loop_4:
                                                        try:
                                                            ...
                                                            if loop_4 != user_choice:
                                                                ...
                                                                r6 = v1 * v2 * v4 * v6 * v7
                                                                if r6 > 1.001:
                                                                    saveFile.write(print(user_choice, loop_1, '->', v1, loop_1, loop_2,
                                                                          '->', v2,
                                                                          loop_2, loop_3, '->', v4,
                                                                          loop_3, loop_4, '->', v6,
